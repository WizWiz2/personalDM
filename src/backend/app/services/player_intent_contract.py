...
_INTENT_MODE_PATTERNS: dict[str, tuple[str, ...]] = {
    "movement": (
        ...
        r"ухожу|уйти|покида\w*|покин\w*|направля\w*|направ\w*|отправля\w*|отправ\w*|"
        r"возвраща\w*|вернут\w*|перехо\w*|перейти|вхо\w*|войти|захо\w*|зайти|"
        r"прихо\w*|прийти|добер\w*|добрат\w*|дой\w*|дойти|перемест\w*)\b",
